...
By default this script starts the backend from `../sm-landing-backend`.
If needed, you can override the backend path:

```bash
BACKEND_DIR=../some-other-backend bun run dev:full
```
